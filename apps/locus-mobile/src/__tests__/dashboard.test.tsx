...
const cleanFixture = require('../../../../packages/locus-sdk/src/__tests__/fixtures/clean-drive.json') as Fixture;
const spoofedFixture = require('../../../../packages/locus-sdk/src/__tests__/fixtures/spoofed-jump.json') as Fixture;
