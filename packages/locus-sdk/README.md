...
LOCUS watches your phone's raw GNSS signals and sensor streams, runs seven physics
...
```
Sensors → Sensor Validation → Fusion Estimator → Integrity Evaluation (7 physics checks)
...
```tsx
import { LocusProvider, createLocusSDK, useLocationStream, useImuStream, useBarometerStream, useGnssMeasurements } from 'locus-sdk';
...
<LocusProvider>{/* your app */}</LocusProvider>
